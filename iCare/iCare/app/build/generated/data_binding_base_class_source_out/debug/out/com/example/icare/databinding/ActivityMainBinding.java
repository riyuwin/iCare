...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
      @NonNull Button loginBtn1, @NonNull TextView taglineTxt) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tagline_txt;
      TextView taglineTxt = ViewBindings.findChildViewById(rootView, id);
      if (taglineTxt == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, imageView, loginBtn1, taglineTxt);
    }
