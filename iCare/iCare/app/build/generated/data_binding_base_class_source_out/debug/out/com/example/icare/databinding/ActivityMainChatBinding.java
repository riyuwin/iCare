...
public final class ActivityMainChatBinding implements ViewBinding {
  ...
  private ActivityMainChatBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton fabNewChat, @NonNull RoundedImageView imageProfile,
      @NonNull AppCompatImageView imageSignOut, @NonNull TextView textName) {
  ...
  public static ActivityMainChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainChatBinding((ConstraintLayout) rootView, fabNewChat, imageProfile,
          imageSignOut, textName);
    }
