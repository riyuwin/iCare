...
public class Doctor_Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView already_account = findViewById(R.id.already_account_text);
        TextView login_ = findViewById(R.id.textSignIn);

        binding.layoutImage.setText("Register Doctor");
        binding.buttonSignUp.setText("REGISTER");
        already_account.setVisibility(View.GONE);
        login_.setVisibility(View.GONE);
    }
    ...
    private void signUp() {
        ...
        String specialty = Get_Credentials.getStringExtra("SPECIALTY");
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            user.put(Constants.KEY_SPECIALTY, specialty);
                            user.put(Constants.KEY_IDENTITY, "Doctor");
                            ...
                            database.collection(Constants.KEY_COLLECTION_USERS)
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            preferenceManager.putString(Constants.KEY_IDENTITY, specialty);
                                            preferenceManager.putString(Constants.KEY_IDENTITY, "Doctor");
                                            preferenceManager.putString(Constants.KEY_IMAGE, encodedImage);
                                            Toast.makeText(Doctor_Signup.this, getString(R.string.registration_success), Toast.LENGTH_LONG).show();
